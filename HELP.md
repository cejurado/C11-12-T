...
* [WebSocket](https://docs.spring.io/spring-boot/docs/2.7.13-SNAPSHOT/reference/htmlsingle/#messaging.websockets)
...
* [Apache Freemarker](https://docs.spring.io/spring-boot/docs/2.7.13-SNAPSHOT/reference/htmlsingle/#web.servlet.spring-mvc.template-engines)
